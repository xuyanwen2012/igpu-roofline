...
static Ctx createCtx() {
  ...
  const bool hasCm = hasDeviceExt(c.pd, "VK_KHR_cooperative_matrix"),
             hasPe = hasDeviceExt(c.pd, "VK_KHR_pipeline_executable_properties");
  VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR xp{
  ...
  VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR ep{
      VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_EXECUTABLE_PROPERTIES_FEATURES_KHR};
  ep.pipelineExecutableInfo = xp.pipelineExecutableInfo;
  eCm.pNext = hasPe ? (void *)&ep : nullptr;
  VkPhysicalDeviceVulkan13Features e13{VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES,
                                       cm.cooperativeMatrix ? (void *)&eCm
                                       : hasPe              ? (void *)&ep
                                                            : nullptr};
  ...
  if (hasPe)
    exts.push_back("VK_KHR_pipeline_executable_properties");
